    ...
    public static function flash()
    {
        if (isset($_SESSION['flash'])) {
            if ($_SESSION['flash']['type'] == "info") {
                echo "
                    <div id='flashbar' class='fixed z-50 right-4 bottom-4 flex gap-4 py-4 ps-4 pe-16 shadow-xl w-fit rounded-lg bg-white bg-linear-to-r from-blue-100 from-10% via-white via-40% to-white to-50%'>
                ...
                echo "
                    <div id='flashbar' class='fixed z-50 right-4 bottom-4 flex gap-4 py-4 ps-4 pe-16 shadow-xl w-fit rounded-lg bg-white bg-linear-to-r from-green-100 from-10% via-white via-40% to-white to-50%'>
                ...
                echo "
                    <div id='flashbar' class='fixed z-50 right-4 bottom-4 flex gap-4 py-4 ps-4 pe-16 shadow-xl w-fit rounded-lg bg-white bg-linear-to-r from-yellow-100 from-10% via-white via-40% to-white to-50%'>
                ...
                echo "
                    <div id='flashbar' class='fixed z-50 right-4 bottom-4 flex gap-4 py-4 ps-4 pe-16 shadow-xl w-fit rounded-lg bg-white bg-linear-to-r from-red-100 from-10% via-white via-40% to-white to-50%'>
