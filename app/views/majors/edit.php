        ...
        <div class="w-full flex flex-col gap-4">
            <div class="flex flex-col gap-4">
                <div class="flex flex-col gap-1 w-full">
                    ...
                    <input required class="w-full p-2 rounded-md border border-zinc-300 bg-zinc-50 focus:outline-none" type="text" name="name" id="name" value="<?= $major['name'] ?>">
                </div>
                <div class="flex flex-col gap-1 w-full">
                    <label class="font-semibold" for="description">Kepanjangan Jurusan</label>
                    <input required class="w-full p-2 rounded-md border border-zinc-300 bg-zinc-50 focus:outline-none" type="text" name="description" id="description" value="<?= $major['description'] ?>">
                </div>
            </div>
