...
<div class="bg-white p-0.5 w-fit rounded-full shadow-md mb-4">
    <ul class="flex *:bg-white *:hover:bg-zinc-100 *:rounded-full *:px-4 *:py-2 *:cursor-pointer">
        <li title="Riwayat pelanggaran yang sudah terjadi" class="bg-zinc-100!"><a href="<?= BASE_URL ?>/violations">Riwayat</a></li>
        <li title="Manajemen jenis pelanggaran"><a href="<?= BASE_URL ?>/violations/types">Jenis</a></li>
    </ul>
</div>
