<div class="flex flex-col md:flex-row justify-between gap-4 items-start md:items-center mb-6 bg-white p-4 rounded-md shadow-md">
    ...
    <div class="flex gap-4 flex-col md:flex-row w-full items-center">
        <button class="flex gap-2 items-center px-3 py-2 bg-white border border-zinc-300 text-zinc-800 rounded-md cursor-pointer transition-colors duration-300 justify-center md:justify-start w-full">
        ...
        <a href="<?= BASE_URL ?>/violation-types/add" class="flex gap-2 items-center px-3 py-2 bg-blue-600 hover:bg-blue-700 transition-colors duration-300 cursor-pointer text-white rounded-md font-medium justify-center md:justify-start w-full">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
