    ...
    <div class="flex flex-col gap-4 bg-white rounded-lg p-6 shadow-md">
        ...
        <div class="w-full flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-1">
                ...
                <textarea class="bg-zinc-50 border border-zinc-300 p-2 rounded-md focus:outline-zinc-400 disabled:bg-zinc-100" name="description" id="description" placeholder="Deskripsi tentang tipe pelanggaran..."></textarea>
            </div>
            <div class="flex flex-col gap-1">
                <label class="font-semibold" for="point-value">Poin Pelanggaran</label>
                <input required class="w-full p-2 rounded-md border border-zinc-300 bg-zinc-50 focus:outline-none" type="number" name="point_value" id="point-value">
            </div>
