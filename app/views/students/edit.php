<div class="flex flex-col gap-1 mb-6 bg-white p-4 rounded-md shadow-md">
    <h1 class="text-2xl font-semibold tracking-wide text-zinc-600">Edit Data Siswa</h1>
    <?php get_breadcrumb() ?>
</div>
        ...
        <div class="w-full flex flex-col gap-4">
            ...
            <div class="space-y-3">
                ...
                <div class="flex gap-4">
                    <div class="w-full">
                        <label for="gender_male" class="flex items-center gap-4 rounded border border-gray-300 bg-white p-3 text-sm font-medium shadow-sm transition-colors hover:bg-gray-50 has-checked:border-blue-600 has-checked:ring-1 has-checked:ring-blue-600 has-checked:bg-blue-100">
                            ...
                            <input type="radio" name="gender" value="M" id="gender_male" class="sr-only" <?= ($student['gender'] === "M") ? "checked" : "" ?>>
                        </label>
                    </div>

                    <div class="w-full">
                        <label for="gender_female" class="flex items-center gap-4 rounded border border-gray-300 bg-white p-3 text-sm font-medium shadow-sm transition-colors hover:bg-gray-50 has-checked:border-pink-600 has-checked:ring-1 has-checked:ring-pink-600 has-checked:bg-pink-100">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                            ...
                            <input type="radio" name="gender" value="F" id="gender_female" class="sr-only" <?= ($student['gender'] === "F") ? "checked" : "" ?>>
                        </label>
                    </div>
                </div>
            </div>
