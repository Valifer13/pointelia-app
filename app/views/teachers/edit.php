<div class="flex flex-col gap-1 mb-6 bg-white p-4 rounded-md shadow-md">
    <h1 class="text-2xl font-semibold tracking-wide text-zinc-600">Edit Data Guru</h1>
    <?php get_breadcrumb() ?>
</div>
        ...
        <div class="w-full flex flex-col gap-4 p-6">
            <div class="flex w-full gap-4">
                <div class="w-full">
                    ...
                    <input required class="w-full p-2 rounded-md border border-zinc-300 bg-zinc-50 focus:outline-none read-only:text-zinc-400" type="text" name="code" id="code" value="<?= $teacher['code'] ?>">
                </div>
                <div class="w-full">
                    <label class="font-semibold" for="username">Username<span class="text-red-500">*</span></label>
                    <input required class="w-full p-2 rounded-md border border-zinc-300 bg-zinc-50 focus:outline-none" type="text" name="username" id="username" placeholder="Username guru..." autocomplete="off" value="<?= $teacher['username'] ?>">
                </div>
            </div>
            <div class="flex w-full gap-4">
                <div class="w-full">
                    <label class="font-semibold" for="fullname">Nama<span class="text-red-500">*</span></label>
                    <input required class="w-full p-2 rounded-md border border-zinc-300 bg-zinc-50 focus:outline-none" type="text" name="fullname" id="fullname" placeholder="Nama guru..." autocomplete="off" value="<?= $teacher['fullname'] ?>">
                </div>
                <div class="w-full">
                    <label class="font-semibold" for="email">Email<span class="text-red-500">*</span></label>
                    <input required class="w-full p-2 rounded-md border border-zinc-300 bg-zinc-50 focus:outline-none" type="email" name="email" id="email" placeholder="Email guru..." autocomplete="off" value="<?= $teacher['email'] ?>">
                </div>
            </div>
            <div class="flex w-full gap-4">
                <div class="w-full">
                    <label class="font-semibold" for="phone_number">Nomor HP<span class="text-red-500">*</span></label>
                    <input required class="w-full p-2 rounded-md border border-zinc-300 bg-zinc-50 focus:outline-none" type="tel" id="phone_number" name="phone_number" value="<?= $teacher['phone_number'] ?>">
                </div>
            </div>
        </div>
    </div>
    <div class="flex flex-col bg-white rounded-lg shadow-md">
        ...
        <div class="w-full flex flex-col gap-4 p-6">
            <div class="flex flex-col gap-1">
                ...
                <input required class="w-full p-2 rounded-md border border-zinc-300 bg-zinc-50 focus:outline-none" type="text" name="position" id="position" placeholder="Jabatan guru..." autocomplete="off" value="<?= $teacher['position'] ?>">
            </div>
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="w-full">
                        <label for="teacher_access" class="flex items-center gap-2 rounded border border-gray-300 bg-white p-3 text-sm text-zinc-700 font-medium shadow-sm transition-colors hover:bg-zinc-50 has-checked:border-green-600 has-checked:ring-1 has-checked:ring-green-600 has-checked:bg-green-100 has-checked:text-green-600">
                            ...
                            <input type="radio" name="access" value="Guru" id="teacher_access" class="sr-only" <?= $role['name'] === "Guru" ? "checked" : "" ?>>
                        </label>
                    </div>
                    ...
                    <div class="w-full">
                        <label for="admin_access" class="flex items-center gap-2 rounded border border-gray-300 bg-white p-3 text-sm text-zinc-700 font-medium shadow-sm transition-colors hover:bg-zinc-50 has-checked:border-blue-700 has-checked:ring-1 has-checked:ring-blue-700 has-checked:bg-blue-100 has-checked:text-blue-700">
                            ...
                            <input type="radio" name="access" value="Admin" id="admin_access" class="sr-only" <?= $role['name'] === "Admin" ? "checked" : "" ?>>
                        </label>
                    </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="w-full">
                        <label for="status_active" class="flex items-center gap-2 rounded border border-gray-300 bg-white p-3 text-sm text-zinc-700 font-medium shadow-sm transition-colors hover:bg-zinc-50 has-checked:border-green-600 has-checked:ring-1 has-checked:ring-green-600 has-checked:bg-green-100 has-checked:text-green-600">
                            ...
                            <input type="radio" name="status" value="1" id="status_active" class="sr-only" <?= $teacher['is_active'] === 1 ? "checked" : "" ?>>
                        </label>
                    </div>
                    ...
                    <div class="w-full">
                        <label for="status_nonactive" class="flex items-center gap-2 rounded border border-gray-300 bg-white p-3 text-sm text-zinc-700 font-medium shadow-sm transition-colors hover:bg-zinc-50 has-checked:border-red-700 has-checked:ring-1 has-checked:ring-red-700 has-checked:bg-red-100 has-checked:text-red-700">
                            ...
                            <input type="radio" name="status" value="0" id="status_nonactive" class="sr-only" <?= $teacher['is_active'] === 0 ? "checked" : "" ?>>
                        </label>
                    </div>
                </div>
            </div>
