...
<div class="bg-white w-full overflow-x-auto p-4 rounded-md shadow-md mb-6">
    <table class="w-full text-left border-collapse">
        ...
        <tbody class="text-sm">
            ...
            <?php
            $count = ($teachers['pagination']['current_page'] - 1) * 10 + 1;
            ...
            ?>
                <tr class="border-b border-zinc-100 hover:bg-zinc-50/80 whitespace-nowrap transition-colors group">
                    ...
                    <td class="p-4 text-right pr-2">
                        <button class="data-option-btn p-1 border border-zinc-200 w-fit rounded-md inset-shadow-zinc-400 transition-all duration-500 cursor-pointer" data-id="<?= $teacher['code'] ?>" data-name="<?= $teacher['fullname'] ?>">
...
<div class="pagination flex gap-5 py-4 justify-center px-5 bg-white rounded-md shadow-md">
    <ul class="flex justify-center gap-3 text-gray-900">
        <li>
            <a href="<?= $teachers['pagination']['has_prev'] ? BASE_URL . '/teachers/page/' . ($teachers['pagination']['current_page'] - 1) : '#' ?>" class="grid size-8 place-content-center rounded border border-gray-200 transition-colors hover:bg-gray-50 rtl:rotate-180" aria-label="Previous page">
        ...
        <li class="text-sm/8 font-medium tracking-widest"><?= $teachers['pagination']['current_page'] ?>/<?= $teachers['pagination']['last_page'] ?></li>

        <li>
            <a href="<?= $teachers['pagination']['has_next'] ? BASE_URL . '/teachers/page/' . ($teachers['pagination']['current_page'] + 1) : '#' ?>" class="grid size-8 place-content-center rounded border border-gray-200 transition-colors hover:bg-gray-50 rtl:rotate-180" aria-label="Next page">
                <svg xmlns="http://www.w3.org/2000/svg" class="size-4" viewBox="0 0 20 20" fill="currentColor">
