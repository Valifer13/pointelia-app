<div class="flex flex-col gap-1 mb-6 bg-white p-4 rounded-md shadow-md">
    <h1 class="text-2xl font-semibold tracking-wide text-zinc-600">Edit Data Kelas</h1>
    <?php get_breadcrumb() ?>
</div>
        ...
        <div class="w-full flex flex-col gap-4">
            <div class="flex flex-col md:flex-row gap-4">
                <div class="flex flex-col gap-1 w-full">
                    ...
                    <input required class="w-full p-2 rounded-md border border-zinc-300 bg-zinc-50 focus:outline-none" type="text" name="grade_class" id="grade_class" list="Grades" value="<?= $student_class['grade'] ?>">
                    <datalist id="Grades">
                ...
                <div class="flex flex-col gap-1 w-full">
                    ...
                    <input required class="w-full p-2 rounded-md border border-zinc-300 bg-zinc-50 focus:outline-none" type="text" name="major" id="major" list="Majors" value="<?= $student_class['major_name'] ?>">
                    <datalist id="Majors">
            ...
            <div class="flex flex-col md:flex-row gap-4">
                <div class="flex flex-col gap-1 w-full">
                    ...
                    <input required class="w-full p-2 rounded-md border border-zinc-300 bg-zinc-50 focus:outline-none" type="text" name="form_tutor" id="form_tutor" list="FormTutors" value="<?= $student_class['form_tutor_code'] ?>">
