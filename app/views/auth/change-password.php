...
<head>
    ...
    <title>Halaman Buat Ulang Password</title>
    ...
    <div class="w-full max-w-md p-6">
        <div class="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-500 text-sm">Ubah password dengan yang baru. <a href="<?= BASE_URL ?>/dashboard" class="text-zinc-600 font-medium hover:text-blue-500">Kembali?</a></p>
            </div>
