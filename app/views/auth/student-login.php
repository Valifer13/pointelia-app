    ...
    <div class="w-full max-w-md p-6">
        <div class="bg-white rounded-2xl shadow-lg p-8">
            ...
            <form action="" method="post">
                <div class="mb-5">
                    <label for="nis" class="block mb-2 text-sm font-medium text-gray-700">NIS</label>
                    <input type="text" id="nis" name="nis" placeholder="NIS Anda" required
                ...
                <div class="mb-5 relative">
                    ...
                    <input type="password" id="password" name="password" placeholder="••••••••" required
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                    <span class="absolute right-4 top-[38px] cursor-pointer text-gray-400 hover:text-gray-600">&#128065;</span>
                </div>
                ...
                <div class="flex justify-end mt-2">
                    <a href="<?= BASE_URL ?>/login/teacher" class="text-blue-500 hover:text-blue-700">Login sebagai guru</a>
                </div>
            </form>
