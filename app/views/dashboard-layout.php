...
<body class="font-main bg-zinc-50">
    <header class="bg-white border border-zinc-100 flex justify-between px-5 py-2 rounded-lg w-full mx-auto">
        ...
        <div class="flex gap-4 *:text-sm">
            <button class="cursor-pointer border border-transparent transition-all duration-300 text-zinc-700 hover:text-zinc-900 hover:border-zinc-300 hover:bg-zinc-100 px-2 py-0.5 rounded-md" onclick="window.location.assign('http://pointeliaapp.test/public/auth/sign-out')">Sign Out</button>
