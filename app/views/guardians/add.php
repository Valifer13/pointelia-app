<div class="flex flex-col gap-1 mb-6 bg-white p-4 rounded-md shadow-md">
    <h1 class="text-2xl font-semibold tracking-wide text-zinc-600">Tambah Data Orang Tua / Wali</h1>
    <?php get_breadcrumb() ?>
</div>
        ...
        <div class="w-full flex flex-col gap-4">
            <div class="flex w-full gap-4 flex-col md:flex-row">
                ...
                <div class="w-full">
                    ...
                    <input required class="w-full p-2 rounded-md border border-zinc-300 bg-zinc-50 focus:outline-none" type="job" name="job" id="job" placeholder="Pekerjaan wali" autocomplete="off">
                </div>
            </div>
            <div class="flex w-full gap-4">
                <div class="w-full">
                    <label class="font-semibold" for="phone_number">Nomor HP</label>
                    <input required class="w-full p-2 rounded-md border border-zinc-300 bg-zinc-50 focus:outline-none" type="tel" id="phone_number" name="phone_number" placeholder="Nomor handphone wali...">
                </div>
            </div>
